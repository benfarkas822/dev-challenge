...
const AddNewContact = ({setContacts, setAddNewContact}) => {
    ...
    return (
        <div
            ...
            <div
                className='flex flex-col max-w-full mx-4 md:w-1/2 lg:w-[368px] md:mx-auto bg-stone-50 dark:bg-[#141414] z-10 p-5'>
                ...
                <form className='flex flex-col gap-y-6 h-full' onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end gap-x-3 mt-10">
                        <div className="btn-secondary" onClick={() => setAddNewContact(false)}>Cancel</div>
